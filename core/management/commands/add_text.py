...
class Command(BaseCommand):
    def handle(self, *args, **options):
        texts = [
            ...
            ['worker_zones', 'Пожалуйста, выберите территориальные зоны, в которых вы готовы работать (можно несколько):', ''],
            ['employer_zones', 'Пожалуйста, выберите территориальные зоны, в которых вы ищете сотрудников (можно несколько):', 'אנא בחר את האזורים הטריטוריאליים שבהם אתה מחפש עובדים (ניתן לבחור כמה):'],
            ['need_zone', 'Нужно выбрать хотя бы одну территориальную зону', 'יש לבחור לפחות אזור טריטוריאלי אחד'],
            ['worker_about', 'Пожалуйста, расскажите кратко о себе/рабочих предпочтениях', ''],
            ['worker_min_salary', 'Пожалуйста, укажите минимальную заработную плану в ₪ (введите целое число)', ''],
            ['wrong_min_salary', 'Не похоже на значение зарплаты, должна быть целым числом. Введите минимальную заработную плату в ₪.', 'לא נראה כמו סכום שכר, יש להזין מספר שלם. אנא הזן את שכר המינימום ב₪'],
            ...
            ['choose_work_type', 'Выберите тип занятости:', 'בחר את סוג ההעסקה:'],
            ['name', 'Имя:', 'שם:'],
            ['phone', 'Номер телефона:', 'מספר טלפון:'],
            ['zones', 'Территориальные зоны:', 'אזורים טריטוריאליים:'],
            ['min_salary', 'Заработная плата от:', 'שכר מ-:'],
            ['work_type', 'Тип занятости:', 'סוג העסקה:'],
            ...
            ['employer_min_salary', 'Пожалуйста, укажите минимальную заработную плату в ₪ (введите целое число)', 'אנא ציין את שכר המינימום ב₪ (הזן מספר שלם)'],
            ...
            ['min_min_salary', 'Минимальная заработная плата от:', ''],
            ['max_min_salary', 'Максимальная заработная плата от:', ''],
            ...
            ['selfie', 'Пожалуйста, отправьте вашу фотографию профиля', ''],
        ]
